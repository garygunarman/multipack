			...
			<div class="main">
				...
				<div class="maincontent clearfix">
					...
					<div class="breadcrumbs">
						...
						<span>/</span>
						<a class="selected">Edit Account Details</a>
					</div>

					<div class="ordercontent">

						<form action="<?php echo $prefix;?>/order/details" method="POST">
						<div id="register">
							<div id="registerhead" class="head">EDIT ACCOUNT DETAILS</div>
							<div class="alert-message success">
							     Message goes here.
							</div>
							<div id="editaccount" class="content">
								<fieldset>
									<div>
									...
									<div>
										<label for="password_r">Old Password </label>
									...
									<div>
										<label for="password_c_r">Retype New Password </label>
									...
									<div id="newsletter">
										...
										<div class="cap">
											<div class="capline1">Subscribe to Multipack SP email updates</div>
										</div>
									</div>
									<div class="field" style="padding-right: 35px">
