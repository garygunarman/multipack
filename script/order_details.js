...
function changeFirstName(){
	if (document.getElementById("order_shipping_first_name").value == ""||document.getElementById("order_shipping_first_name").value == lastFirstNameValue){
		...
		lastFirstNameValue = document.getElementById("billing_first_name_form_input").value;
	}
	
}

function changeLastName(){
	if (document.getElementById("order_shipping_last_name").value == ""||document.getElementById("order_shipping_last_name").value == lastFirstNameValue){
		document.getElementById("order_shipping_last_name").value = document.getElementById("order_billing_last_name").value
		lastLastNameValue = document.getElementById("billing_last_name_form_input").value;
	}
}
