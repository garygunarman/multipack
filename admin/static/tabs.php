<div class="admin_tab_group">
	...
	<a href="<?php echo $prefix;?>stock?category_id=<?php echo $category_id?>"><div class="admin_tab <?php if ($selected_tab=="stock"||$selected_tab=="stock_2"){echo "selected_tab";}?>" id="stock_tab">Stock Info</div></a>
	
	<!--promo-->
	<a href="<?php echo $prefix;?>promo?category_id=<?php echo $category_id?>"><div class="admin_tab <?php if ($selected_tab=="promo"){echo "selected_tab";}?>" id="promo_tab">Promo</div></a>
	<!--promo-->
