...
if ($_SESSION["user_status"]!="admin"){
	...
	if (mysql_num_rows($get_list)!=null){
			...
			$color_image = $get_list_array["color_image"];
	}
...
<head>	
		<?php
			$page_title = " Color Detail | ".$color_name;
...
<body onload="">
	...
	<form method="post" id="color_form" action="update_detail.php" enctype="multipart/form-data">
	<div id="page_title_bar">
		<div id="page_title_bar_fill">
			<div id="page_title"><a href="../color"><input type="button" class="back_button left_ black_tiny_button tiny_button" value="" /></a><?php echo $color_name;?></div>
			<div id="button_bar">
