...
<head>	
		<?php
			$page_title = " Edit Category | ".$category_name;
...
<body onload="initializationSidebarTable()">
	...
	<div id="page_title_bar">
		<div id="page_title_bar_fill">
			...
			<div id="page_title"><?php echo $category_name;?></div>
			<div id="button_bar">
				...
				<input type="button" onclick="deleteCategory()" class="delete_button image_button right_ h26_button red_button button" value="Delete">
	...
	<div class="fill_container_sidebar" >
		...
		<div class="fill_group">
			<div class="fill_row">
			<div class="fill_title">Edit Category</div>
