...
mysql_query("
	UPDATE tbl_product
	SET product_category = '$product_category', product_name = '$product_name', product_size_type_id = '$size_type_id', designer_id = '$designer_id'
	WHERE id = '$product_id'
",$con);
...
header("location:details.php?product_id=".$product_id."&category_id=".$category_id);
