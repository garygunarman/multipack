<form method="post" action="../dashboard/update.php" enctype="multipart/form-data">
<?php
//page
if ($_GET["page"]==""){
	$page = 1;
...
?>
<div class="admin_table" id="first_admin_table">
	<div class="hidden" id="sort_by"><?php echo $_GET["sort_by"];?></div>
	<div class="admin_panel">
		<div class="table_title">Latest Verified Orders</div>
		...
		<div class="panel_menu_right status_extension status_extension1">
		...
		<div class="panel_label_right status_extension status_extension1">&nbsp;&nbsp;to</div>
		
		<div class="panel_menu_right">
			<select name="action" id="action1" class="panel_combo_box" onchange="showExtension1()">
	...
	<div class="admin_header_row">
		...
		<div class="hidden table_row" id="row_search" >
	...
	<div class="right_ table_field delivered_field"><input type="radio" id="status_search_verified" name="status_search_verified" onclick="searchStatus('delivered')"
		<?php
		...
		?>
		/></div>
	<div class="right_ table_field verified_field"><input type="radio" id="status_search_verified" name="status_search_verified" onclick="searchStatus('verified')"
		<?php
		...
		?>
		/></div>
	<div class="right_ table_field confirmed_field"><input type="radio" id="status_search_verified" name="status_search_verified" onclick="searchStatus('confirmed')"
		<?php
		...
		?>
		/></div>		
	<div class="right_ table_field open_field"><input type="radio" id="status_search_verified" name="status_search_verified" onclick="searchStatus('open')"
		<?php
	...
	if (mysql_num_rows($get_list)!=null){
		$row=11;
		for ($row_count=1;$row_count<=mysql_num_rows($get_list);$row_count++){
			...
			echo '<div class="left_ table_field no_field">'.$row_count.'</div>';
			...
			echo '<div class="right_ table_field shipping_no_field"><input type="text" class="search_text_box table_text_box" id="shipping_number_'.$row.'" name="shipping_number['.$get_list_array["order_id"].']" value="'.$get_list_array["order_shipping_number"].'" /></div>';
			
			echo '<div class="right_ table_field delivered_field"><input type="radio" id="status_search_verified_'.$row.'" name="status_search_verified_'.$row.'" ';
			...
			echo '<div class="right_ table_field verified_field"><input type="radio" id="status_search_verified_'.$row.'" name="status_search_verified_'.$row.'" ';
			...
			echo '<div class="right_ table_field confirmed_field"><input type="radio" id="status_search_verified_'.$row.'" name="status_search_verified_'.$row.'" ';
			...
			echo '<div class="right_ table_field open_field"><input type="radio" id="status_search_verified_'.$row.'" name="status_search_verified_'.$row.'" ';
		...
		echo '<div class="odd_row table_row empty_row" id="row_'.$row.'" >You currently don\'t have any order</div>';
	}
	?>
	</form>
	<!--
