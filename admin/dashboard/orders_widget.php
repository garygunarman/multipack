...
<div class="admin_table">
	...
	<div class="admin_panel">
		...
		<div class="panel_menu_right status_extension status_extension3">
		...
		<div class="panel_label_right status_extension status_extension3">&nbsp;&nbsp;to</div>
		
		<div class="panel_menu_right">
			<select name="action" id="action3" class="panel_combo_box" onchange="showExtension3()">
