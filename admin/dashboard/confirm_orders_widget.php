...
<div class="admin_table">
	...
	<div class="admin_panel">
		<div class="table_title">Latest Confirmed Orders</div>
		...
		<div class="panel_menu_right status_extension status_extension2">
		...
		<div class="panel_label_right status_extension status_extension2">&nbsp;&nbsp;to</div>
		
		<div class="panel_menu_right">
			<select name="action" id="action2" class="panel_combo_box" onchange="showExtension2()">
	...
	<div class="right_ table_field delivered_field"><input type="radio" id="status_search_confirm" name="status_search_confirm" onclick="searchStatus('delivered')"
		<?php
		...
		?>
		/></div>
	<div class="right_ table_field verified_field"><input type="radio" id="status_search_confirm" name="status_search_confirm" onclick="searchStatus('verified')"
		<?php
		...
		?>
		/></div>
	<div class="right_ table_field confirmed_field"><input type="radio" id="status_search_confirm" name="status_search_confirm" onclick="searchStatus('confirmed')"
		<?php
		...
		?>
		/></div>		
	<div class="right_ table_field open_field"><input type="radio" id="status_search_confirm" name="status_search_confirm" onclick="searchStatus('open')"
		<?php
	...
	if (mysql_num_rows($get_list)!=null){
		...
		for ($row_count=1;$row_count<=mysql_num_rows($get_list);$row_count++){
			...
			echo '<div class="right_ table_field delivered_field"><input type="radio" id="status_search_confirm_'.$row.'" name="status_search_confirm_'.$row.'" ';
			...
			echo '<div class="right_ table_field verified_field"><input type="radio" id="status_search_confirm_'.$row.'" name="status_search_confirm_'.$row.'" ';
			...
			echo '<div class="right_ table_field confirmed_field"><input type="radio" id="status_search_confirm_'.$row.'" name="status_search_confirm_'.$row.'" ';
			...
			echo '<div class="right_ table_field open_field"><input type="radio" id="status_search_confirm_'.$row.'" name="status_search_confirm_'.$row.'" ';
